            ...
            <div className="min-h-[90vh] pt-16 px-6 md:px-20 flex items-center justify-center">
                ...
                <div className="space-y-6">
                    ...
                    {role === "ADMIN" || data?.subscription?.status === "ACTIVE" ? (
                        <button className="w-full px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-500 transition">
                        Watch Lectures
                        </button>
                    ) : (
                        <button className="w-full px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition">
